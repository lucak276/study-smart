...
class ChangeTask extends StatefulWidget {
  const ChangeTask({Key? key, required this.task}) : super(key: key);

  final Task task;

  @override
  State<ChangeTask> createState() => _ChangeTaskState();
}

class _ChangeTaskState extends State<ChangeTask> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: getReturnAppBar(height, false, 'Task Bearbeiten', mainRedScheme),
